...
# Compatibility entry point. The supported Proxmox CT installer follows
# the community-scripts/ProxmoxVED layout in ct/surroundcore.sh.

SCRIPT_DIR=$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)
LOCAL_SCRIPT="$SCRIPT_DIR/../ct/surroundcore.sh"
REMOTE_SCRIPT="https://raw.githubusercontent.com/lurcheous73/SurroundCore/proxmox-ct/ct/surroundcore.sh"
