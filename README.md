...
See [SUPPORT.md](SUPPORT.md) for what to include in a support request and the current support scope. A dedicated email-support address will be added there once the mailbox is assigned.
